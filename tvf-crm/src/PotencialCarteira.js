  ...
  return (
    <div className="main">
      ...
      <div className="kanban-toolbar">
        ...
        <label style={{ fontSize: 11, color: 'var(--text-3)' }}>De <input className="lm-input" type="date" style={{ width: 130, display: 'inline-block' }} value={filtroDataDe} onChange={e => setFiltroDataDe(e.target.value)} /></label>
        <label style={{ fontSize: 11, color: 'var(--text-3)' }}>Até <input className="lm-input" type="date" style={{ width: 130, display: 'inline-block' }} value={filtroDataAte} onChange={e => setFiltroDataAte(e.target.value)} /></label>
      ...
      {podeAdicionarCliente(user) && (
        <div className="kanban-toolbar">
          ...
          <span style={{ fontSize: 11, color: 'var(--text-4)', marginLeft: 'auto' }}>{clientesFiltrados.length} cliente{clientesFiltrados.length !== 1 ? 's' : ''}</span>
        </div>
      )}
      {!podeAdicionarCliente(user) && (
        <div className="kanban-toolbar">
