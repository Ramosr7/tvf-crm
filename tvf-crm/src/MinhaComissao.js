    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="lead-modal" style={{ width: 640 }} onClick={e => e.stopPropagation()}>
        ...
        <div className="lm-body">
          {visao === 'apurado' && (
            <div className="lm-resumo" style={{ marginBottom: 12, fontSize: 12, color: 'var(--text-3)' }}>
...
export default function MinhaComissao() {
  ...
  return (
    <div className="main">
      ...
      <div className="lm-resumo" style={{ marginBottom: 16, fontSize: 12, color: 'var(--text-3)' }}>
      ...
      <div className="kanban-toolbar" style={{ marginBottom: 16 }}>
        ...
        <span style={{ fontSize: 12, color: 'var(--text-3)' }}>Dias úteis: {duTotais} total, {duDecorridos} decorrido(s), {duRestantes} restante(s)</span>
      </div>
